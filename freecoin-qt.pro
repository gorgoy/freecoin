...
HEADERS += src/qt/freecoingui.h \
    ...
    src/qt/freecoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/freecoin.cpp src/qt/freecoingui.cpp \
    ...
    src/qt/freecoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/freecoinstrings.cpp \
    src/qt/freecoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/freecoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/freecoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/freecoin-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
...
windows:RC_FILE = src/qt/res/freecoin-qt.rc
